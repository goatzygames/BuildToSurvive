...
DECLARE_DYNAMIC_MULTICAST_DELEGATE(FEnemeyKilled);
 ...
 */
UCLASS(abstract)
class BUILDTOSURVIVE_API AShooterNPC : public ABuildToSurviveCharacter, public IShooterWeaponHolder
{
	GENERATED_BODY()
...
public:
	...
	TArray<TSubclassOf<AShooterWeapon>> WeaponClasses;
